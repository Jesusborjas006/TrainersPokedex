      ...
      <div className="flex flex-col space-y-10 gap-x-10 md:flex-row md:space-y-0 ">
        {status === "success" ? (
          <div className="bg-white rounded-xl flex-1">
            ...
            <div className="p-6">
              <img
                className="bg-gray-300 rounded-lg mx-auto w-[200px] p-6"
                src={data.sprites[1]}
                alt={data.name}
              />
            </div>
          ...
          <div className="bg-white rounded-xl flex-1 h-[692px]">
            <div className="flex justify-center pt-6">
              <label>Name or ID:</label>
              <input
                className="border pl-1 ml-1"
            ...
            <div className="w-[200px] h-[200px] bg-gray-300 mx-auto mt-6 rounded-lg"></div>
            <h3 className="text-center capitalize text-xl font-medium py-6">
              Undefined
